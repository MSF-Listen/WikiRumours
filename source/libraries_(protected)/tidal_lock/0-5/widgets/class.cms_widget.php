		...
		private function createView() {
			...
			elseif ($this->screen == 'edit_content' || $this->screen == 'add_content') {
					...
					if ($this->content_type == 'p') {
						...
						/* Content */		$this->html .= $form->row('textarea', 'content', (@$_POST['content'] ? $_POST['content'] : @$this->cms[0]['content']), true, 'Content|Plain text or HTML', 'form-control fullhtmleditor', null, null, ['rows'=>'10'], null, ['onChange'=>'document.getElementById("preview").innerHTML=this.value;']);
					...
					elseif ($this->content_type == 'b') {
						...
						/* Language */ 		$this->html .= $form->row('language', 'language_id', (@$_POST['language_id'] ? $_POST['language_id'] : @$this->cms[0]['language_id']), false, 'Language', 'form-control');
						/* Domain Alias */ 	if (count($this->domain_aliases)) $this->html .= $form->row('select', 'domain_alias_id', (@$_POST['domain_alias_id'] ? $_POST['domain_alias_id'] : @$this->cms[0]['domain_alias_id']), false, 'Domain Alias', 'form-control', $this->domain_aliases);
						/* Content */		$this->html .= $form->row('textarea', 'content', (@$_POST['content'] ? $_POST['content'] : @$this->cms[0]['content']), true, 'Content|Plain text or HTML', 'form-control fullhtmleditor', null, null, ['rows'=>'10'], null, ['onChange'=>'document.getElementById("preview").innerHTML=highlightMergeFields(this.value);']);
					...
					elseif ($this->content_type == 'c') {
						...
						/* Language */ 		$this->html .= $form->row('language', 'language_id', (@$_POST['language_id'] ? $_POST['language_id'] : @$this->cms[0]['language_id']), false, 'Language', 'form-control');
						/* Domain Alias */ 	if (count($this->domain_aliases)) $this->html .= $form->row('select', 'domain_alias_id', (@$_POST['domain_alias_id'] ? $_POST['domain_alias_id'] : @$this->cms[0]['domain_alias_id']), false, 'Domain Alias', 'form-control', $this->domain_aliases);
						/* Content */		$this->html .= $form->row('textarea', 'content', (@$_POST['content'] ? $_POST['content'] : @$this->cms[0]['content']), true, 'Content|Plain text or HTML', 'form-control fullhtmleditor', null, null, ['rows'=>'3']);
